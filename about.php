...
?>
  ...
  <div class="container" style="margin-top:7rem;">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 my-3 text-center">
        <img src="img/reuel3.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
      ...
      <div class="col-lg-6 my-3 text-center">
        <img src="img/kelly2.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
