                ...
                <form id="message-form">
                    <div class="modal-content">
                        ...
                        <div class="modal-body info-msg"> 
                            <div class="mb-3">
                                <textarea class="form-control shadow-none" name="email-message" id="email-message" style="resize:none;" rows="5" placeholder="Type a message to be sent to the user..."></textarea>
                            </div>
                        </div>
