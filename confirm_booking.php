...
?>
    ...
    <div class="col-12 my-5 mb-4 px-4">
        <div class="h2 fw-bold text-center">Confirm Barrowing</div>
        ...
        <div class="col-12 my-7 mb-4 px-7">
          ...
          <div class="card mb-4 border-0 shadow-sm rounded-3">
            ...
            <form action="charge.php" id="booking_form" method="POST" >
              <h6 class="mb-3 text-center fw-bold">Barrowing Details</h6>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-3">
                    <label class="form-label mb-1">Course/Year</label>
    ...
    <select class='form-select shadow-none' aria-label='Default select example' name='teacher' required>
        ...
        ?>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="number" value="1" class="form-control shadow-none"  required name="quantity">
                  </div>
                  <div class="col-md-3 mb-3">
                    <label class="form-label mb-1">Group No.</label>
                    <input name="group_no" type="number"  class="form-control shadow-none">
                  </div>
                  <div class="col-md-5 mb-3">
                    <label class="form-label mb-1">Volume (if chemical)</label>
                    <input name="volume" type="number"  class="form-control shadow-none">
                  </div>
                  <div class="col-md-6 mb-3">
                  ...
                  <h6 class="text-center fw-bold text-danger" id="pay_info">Please Provide Date and time first before barrowing </h6>
                  ...
                  <button name="pay_now" type="submit" class="btn btn-success w-100 text-white shadow-none mb-1" disabled>Barrowing Now</button>
                  </div>
                </div>
            </form>
            </div>
...
?>
  ...
  <h6 class="text-center bg-dark text-white p-3m m-0">Designed and Develop by riyuu dev</h6>
<!-- Login Modal -->
