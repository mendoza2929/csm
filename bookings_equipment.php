...
?>
    ...
    <div class="col-12 my-5 px-4">
        ...
        <a href="#" class="text-secondary text-decoration-none">Borrowing</a>
          ...
          $query = "SELECT eo.*, ed.*  FROM `equipment_order_final` eo INNER JOIN `equipment_details_final` ed ON eo.booking_id = ed.booking_id WHERE  ((eo.booking_status ='approved') OR (eo.booking_status='breakage') OR (eo.booking_status='payment failed')) AND  (eo.user_id=?)  ORDER BY eo.booking_id DESC ";
            ...
            echo<<<bookings
              <div class='col-md-4 px-4 mb-4 w-30'>
                <div class="bg-white p-3 rounded shadown-sm">
                    <h5 class="fw-bold text-center">$data[equipment_name]</h5>
                    <b>Date: </b> $date <br>
                    <b>Borrow: $data[quantity] pcs</b>
                    <br>
                    <b>Remarks Breakage: $data[quantity_no] pcs</b>
                    <br>
                    <b>Responsible for Breakage: $data[res_breakage] </b>
                    <br>
